        ...
        public override void GoToMethod(string methodName)
        {
            switch (methodName)
            {
                ...
                case "GetDictionaryList":
                    ...
                    break;
                case "GetParasList":
                     DataGrid<DictionaryEntity> sdg = new DataGrid<DictionaryEntity>();
                    sdg = ActionTool.DeserializeParametersByFields<DataGrid<DictionaryEntity>>(context, actionType);

                    DictionaryEntity sdeg = ActionTool.DeserializeParameters<DictionaryEntity>(context, actionType);
                    GetParasList(sdg, sdeg);
                    break;
