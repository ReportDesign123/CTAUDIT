<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CycleManager.aspx.cs" Inherits="Audit.ct.basic.CycleManager" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        var urls = {
            DicCGridUrl: "../../handler/BasicHandler.ashx?ActionType=" + BasicAction.ActionType.Grid + "&MethodName=" + BasicAction.Methods.CycManagerMethods.GetCycleList + "&FunctionName=" + BasicAction.Functions.CycleManager,
            functionsUrl: "../../handler/BasicHandler.ashx",
            AddDicC: "AddCycle.aspx"
        };
        var roleGrid;
        var classHelp;
        $(
        ...
        var menuManager = {
            AddMenu: function () {
                menuManager.OpenDialog(urls.AddDicC, "创建周报周期", "add");
            },
            EditMenu: function () {
                ...
                menuManager.OpenDialog(urls.AddDicC + ur, "编辑周报周期", "edit");
            },
            RemoveMenu: function () {
                ...
                var parameters = CreateParameter(BasicAction.ActionType.Post, BasicAction.Functions.CycleManager, BasicAction.Methods.CycManagerMethods.DeleteCycle, para);
                ...
                $('#Dialog').dialog({
                    ...
                    buttons: [{
                        ...
                        handler: function () {
                            var parameters = {};
                            if (type == "add") {
                                parameters = getParameters(BasicAction.ActionType.Post, BasicAction.Methods.CycManagerMethods.SaveCycle);
                                DataManager.sendData(urls.functionsUrl, parameters, resultManagers.success, resultManagers.fail);
                            } else if (type == "edit") {
                                parameters = getParameters(BasicAction.ActionType.Post, BasicAction.Methods.CycManagerMethods.UpdateCycle);
                                DataManager.sendData(urls.functionsUrl, parameters, resultManagers.success, resultManagers.fail);
                            }
        ...
        <table class="easyui-datagrid" id="roleGrid" data-options="singleSelect:true,method:'post',fit:true,fitColumns:true,sortName:'Code',sortOrder:'ASC',url:urls.DicCGridUrl,toolbar:toolBar,pagination:true">
            <thead>
                <tr>
                    ...
                    <th data-options="field:'KSRQ',width:50,align:'left'">
                        开始日期
                    </th>
                    <th data-options="field:'JSRQ',width:50,align:'left'">
                        结束日期
                    </th>
