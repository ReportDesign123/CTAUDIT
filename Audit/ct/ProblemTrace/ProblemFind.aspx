<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProblemFind.aspx.cs" Inherits="Audit.ct.ProblemTrace.ProblemFind" %>
...
<body class="easyui-layout" style="background: #F4F4F4;">
    <div data-options="region:'north',collapsible:false" style=" height:32px; padding:2px;background-color:#E0ECFF ;overflow:hidden">
        <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add',iconAlign:'left',line:true" onclick="MainManager.menuManager.AddMenu()" style="width:100px; float:left "plain="true">问题追踪历史</a>
