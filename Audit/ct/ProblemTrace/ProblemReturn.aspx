<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProblemReturn.aspx.cs" Inherits="Audit.ct.ProblemTrace.ProblemReturn" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        var urls = {
            ...
            ReturnDetailUrl: "ct/ProblemTrace/ProblemReturnDetail.aspx"
        };
        var problemList;
        ...
        var MainManager = {
            ...
            RespondProblem: function () {
                var row = $("#problemList").datagrid("getSelected");
                if (row) {
                    parent.NavigatorNode({ id: "086", text: row.Title + "：问题反馈", attributes: { url: urls.ReturnDetailUrl + "?Id=" + row.Id} });
                } else {
...
<body class="easyui-layout">
    <div data-options="region:'north',collapsible:false" style=" height:32px;padding:2px;background-color:#E0ECFF;overflow:hidden">
            <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-comment'" onclick="MainManager.RespondProblem()" style="width:90px; float:left "plain="true">问题反馈</a>
            <div class="datagrid-btn-separator"></div>
            <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-closs16'" onclick="MainManager.delReplayAll()" style="width:110px; float:left "plain="true">清空反馈记录</a>
            <div class="datagrid-btn-separator"></div>
    </div>
    <div data-options="region:'center'" style="border:0px">
        ...
        <table class="easyui-datagrid" id="problemList" data-options="singleSelect:true,method:'post',fit:true,fitColumns:true,sortName:'CreateTime',sortOrder:'ASC',pagination:true,toolbar:'#toolbar',onDblClickRow:MainManager.RespondProblem">
            <thead>
                <tr>
