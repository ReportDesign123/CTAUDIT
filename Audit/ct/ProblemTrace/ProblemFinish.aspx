<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProblemFinish.aspx.cs" Inherits="Audit.ct.ProblemTrace.ProblemFinish" %>
        ...
        var MainManager = {
            ...
            finishProblem: function () {
                ...
                if (rows.length > 0) {
                    ...
                    para = CreateParameter(ProblemTraceAction.ActionType.Post, ProblemTraceAction.Functions.ProblemTraceAction, ProblemTraceAction.Methods.ProblemManagerMethods.finishProblem, para);
            ...
            cancelFinishProblem: function () {
                ...
                if (rows.length > 0) {
                    ...
                    para.ids = para.ids.substring(0, para.ids.length - 1);
                    para = CreateParameter(ProblemTraceAction.ActionType.Post, ProblemTraceAction.Functions.ProblemTraceAction, ProblemTraceAction.Methods.ProblemManagerMethods.cancelFinishProblem, para);
                    DataManager.sendData(urls.functionsUrl, para, resultManager.success, resultManager.fail, false);
                } else {
                    MessageManager.ErrorMessage("请先选择一行再进行编辑！");
                    return;
...
//                if (!currentState.problemParamter.Companies.Ids) { return; }
            ...
            TabManager: {
                selectTab: function (title, index) {
                    ...
                    var url = "";
                    if (index == 0) {
                        url = CreateUrl(urls.functionsUrl, ProblemTraceAction.ActionType.Grid, ProblemTraceAction.Functions.ProblemTraceAction, ProblemTraceAction.Methods.ProblemManagerMethods.DataGridReportProblemEntity, { State: '2' });
                    } else {
                        url = CreateUrl(urls.functionsUrl, ProblemTraceAction.ActionType.Grid, ProblemTraceAction.Functions.ProblemTraceAction, ProblemTraceAction.Methods.ProblemManagerMethods.DataGridReportProblemEntity, { State: '3' });
                    }
                    $("#problemList").datagrid({
                        url: url,
                        queryParams: parameter
...
<body class="easyui-layout">
    <div data-options="region:'north',collapsible:false" style=" height:61px;overflow:hidden">
        <div id="topTab">
            <div title="问题结题" style="padding:2px;background-color:#E0ECFF;">
            <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-seal'" onclick="MainManager.finishProblem()" style="width:90px; float:left "plain="true">问题结题</a>
            <div class="datagrid-btn-separator"></div>
            <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-publish'" onclick="MainManager.publishProblem()" style="width:90px; float:left "plain="true">重新下达</a>
            <div class="datagrid-btn-separator"></div>
        ...
        <div title="取消结题" style="padding:2px;background-color:#E0ECFF;">
            <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-CancleSeal'" onclick="MainManager.cancelFinishProblem()" style="width:90px; float:left "plain="true">取消结题</a>
            <div class="datagrid-btn-separator"></div>
        </div>
        </div>
    </div>
