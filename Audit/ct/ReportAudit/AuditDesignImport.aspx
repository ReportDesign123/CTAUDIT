<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditDesignImport.aspx.cs" Inherits="Audit.ct.ReportAudit.AuditDesignImport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
     <title>审计格式设置导入</title>
    ...
    <script type="text/javascript">
        ...
        var urls = {
            ...
            DesignManager: "ct/ReportAudit/AuditDesignManager.aspx"
        };
        var FormularManager = {
            AddFormular: function () {
                var node = $("#reportGrid").datagrid("getSelected");
                if (node) {
                    parent.NavigatorNode({ id: "080", text: "审计格式设置", attributes: { url: urls.DesignManager + "?Id=" + node.Id} });
                } else {
...
<body class="easyui-layout">
    ...
    <a class="easyui-linkbutton" data-options="iconCls:'icon-examine16'" style=" width:90px" onclick="FormularManager.AddFormular();" plain="true"> 审计设置</a>
    </div>
