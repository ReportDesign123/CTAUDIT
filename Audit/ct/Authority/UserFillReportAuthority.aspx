<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserFillReportAuthority.aspx.cs" Inherits="Audit.ct.Authority.UserFillReportAuthority" %>
 ...
 <title>填报权限设置</title>
    ...
    <script type="text/javascript">
        var urls = {
            ...
            AuthoriyUrl: "../../handler/BasicHandler.ashx?ActionType=" + BasicAction.ActionType.Grid + "&MethodName=" + BasicAction.Methods.AuthorityMethods.GetFillReportAuthorityCompaniesByUser + "&FunctionName=" + BasicAction.Functions.Authority
        };
        $(function () {
            $("#panel").panel({
        ...
        function saveAll() {
            ...
            var para = CreateParameter(BasicAction.ActionType.Post, BasicAction.Functions.Authority, BasicAction.Methods.AuthorityMethods.SaveAndEditFillReportAuthority, obj);
        ...
        var eventManager = {
            selectEvent: function (rowIndex, rowData) {
                ...
                para = CreateParameter(BasicAction.ActionType.Post, BasicAction.Functions.Authority, BasicAction.Methods.AuthorityMethods.GetFillReportAuthorityCompaniesByUser, para);
...
<body  class="easyui-layout" data-options="fit:true">
    <div data-options="region:'center'" title="<div class='title'>用户</div>" >
        ...
        <table class="easyui-datagrid"  id="userGrid"
                data-options="singleSelect:false,method:'post',border:false,fit:true,fitColumns:true,url:urls.userGridUrl,sortName:'CreateTime',sortOrder:'DESC',pagination: true,toolbar:'#toolBar',onSelect:eventManager.selectEvent">
            <thead>
                <tr>
    ...
    <div data-options="region:'east',title:'',split:true,border:false" style="width:300px;height:100%; ">
