<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddFormular2.aspx.cs" Inherits="Audit.ct.Format.AddFormular" %>
...
//                Grid1.FixedRowColStyle = 0;
        ...
        var cellManager = {
            ...
            GeneralLoadCellDataValue: function (row, col) {
                ...
                var endRow = Grid1.Selection.LastRow;
                var endCol = Grid1.Selection.LastCol;
            ...
            ForeColor_Click: function (foreColor) {
                ...
                //cellManager.GeneralCell(GridManager.SetForeColor, foreColor);
            },
            BackColor_Click: function (backColor) {
                Grid1.Selection.BackColor = backColor;
                // cellManager.GeneralCell(GridManager.SetBackColor, backColor);
            },
            ...
            Formular: {
                ...
                AddEditCaculateFormular: function (firstRow, firstCol, lastRow, lastCol, methodType) {
                    ...
                    if (methodType == "add") {
                        ...
                        formular.Id = guid();
                        formular.sequence = 0;
                        var cellText = Grid1.Cell(formular.firstRow, formular.firstCol).Text;
                    ...
                    if (formularArr.length == 2) {
                        ...
                        $.each(rowColFormular, function (row) {
                            $.each(rowColFormular[row], function (col) {
                                if (Grid1.Cell(row, col)) {
                                    Grid1.Cell(row, col).Text = "公式";
                                } else {
                                    var position = rowColFormular[row][col];
                                    var data = toolManager.DeserializePositoin(position);
                                    delete FormularData.formularMaps[FormularData.currentIndex];
