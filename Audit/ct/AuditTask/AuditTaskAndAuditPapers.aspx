<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditTaskAndAuditPapers.aspx.cs" Inherits="Audit.ct.AuditTask.AuditTaskAndAuditPapers" %>
...
<head id="Head1" runat="server">
  ...
  <script type="text/javascript">
      var urls = {
          AuditPaperUrl: "../../handler/AuditTaskHandler.ashx"
      };
      var grid;
      var box1Data;
      var leftWidth;
      ...
      $(function () {
          ...
          grid = $("#auditGrid").ligerGrid({
              columns: [
                ...
                { display: '审计任务编号', align: 'left', name: 'Code', minWidth: 154 },
                { display: '审计任务名称', align: 'left', name: 'Name', minWidth: 140 }
                ],
              width: '100%',
              height: '100%',
              heightDiff: -5,
              ...
              onSelectRow: function (rowdata, rowid, rowobj) {
                  var para = { AuditTaskId: rowdata.Id };
                  para = CreateParameter(AuditTaskAction.ActionType.Post, AuditTaskAction.Functions.AuditTaskManager, AuditTaskAction.Methods.AuditTaskManagerMethods.GetAuditTaskAuditPapers, para);
      ...
      function SaveClick() {
          ...
          $.each(selecteds, function (index) {
              var parameter = { Id: "", TaskId: "", PaperId: "" };
              parameter.PaperId = selecteds[index].id;
          ...
          var para = CreateParameter(AuditTaskAction.ActionType.Post, AuditTaskAction.Functions.AuditTaskManager, AuditTaskAction.Methods.AuditTaskManagerMethods.BatchUpdataTaskAndPaper, obj);
