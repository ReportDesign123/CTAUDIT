...
namespace CtTool
{
    ...
    public static class JSON
    {
        ...
        {
            return new deserializer(Parameters).Deserialize<T>(json);
        }
                    ...
                    if (v != null)
                    {
                        ...
                        switch (pi.Type)
                        {
                            ...
                            case myPropInfoType.Dictionary:
                                ...
                                temp.Add(v);
                            oset = CreateDictionary(temp, pi.pt, pi.GenericTypes, globaltypes); break;
                             
                            case myPropInfoType.StringKeyDictionary:
                            oset = CreateStringKeyDictionary((Dictionary<string, object>)v, pi.pt, pi.GenericTypes, globaltypes); break;
