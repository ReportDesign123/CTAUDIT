...
//		this.$tool.append("<span/><a href='javascript:void(0)' class='GooFlow_tool_btn' id='"+this.$id+"_btn_fork'><b class='ico_fork'/></a><a href='javascript:void(0)' class='GooFlow_tool_btn' id='"+this.$id+"_btn_join'><b class='ico_join'/></a><a href='javascript:void(0)' class='GooFlow_tool_btn' id='"+this.$id+"_btn_complex'><b class='ico_complex'/></a><a href='javascript:void(0)' class='GooFlow_tool_btn' id='"+this.$id+"_btn_group'><b class='ico_group'/></a>");
	...
	this.$bgDiv.append("<div class='GooFlow_work' style='width:" + (width) + "px;height:" + (height) + "px; overflow:hidden;" + (property.haveHead ? "" : "margin-top:3px") + "'></div>");
...
GooFlow.prototype = {
    ...
    dbClick: function (id) {
        if (this.onItemDbClick && this.onItemDbClick != null) {
            this.onItemDbClick(id);
        }
    },
    ...
    loadData: function (data) {
        ...
        if (data.max) {
            this.$max = property.initNum = data.max;
        }
    ...
    exportData: function () {
        return { nodes: this.$nodeData, lines: this.$lineData, areas: this.$areaData, max: this.$max };
    },
    //清空工作区及已载入的数据
    clearData: function () {
